...
public class GetRebalanceOrders extends SessionServlet 
{
	...
	protected void doPostProcessRequest(SSRequest ssRequest, SSResponse ssResponse) throws Exception 
	{
		...
		GetPendingOrdersResponse res = PendingOrdersOperations.getRebalanceOrders(ssRequest.getSession().getUserId());
