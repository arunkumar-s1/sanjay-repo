package com.msf.samco.encryption;
...
public class Encryption 
{
			...
			InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException 
	{
		...
		String secretByteKeys = "indiabullsots201";

		String s = "{\"request\":{\"data\":{},\"app_version\":\"1.0.0\"}}";

		String sEncContent = e.encryptText(secretByteKeys, s);

		String sDecContent = e.decryptText(secretByteKeys, "y2+POjOkkk8hc2vYZtqC+YSwPr48v6FH1Kgu1SMCf6W8AO6JAhRqUzcOSpC3mZm+");
